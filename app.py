...
train = df[df["LABEL"]==1][["time", "yaowuzhonglei", "yibao", "ade", "xuanjiao"]]
...
# 导入模型文件
with open("LogisticRegression1282260.pkl", 'rb') as f:
    model = pickle.load(f)
...
YIBAO = d4[col[2].selectbox("医保类型", ["职工医保", "居民医保", "其他保障"])]
